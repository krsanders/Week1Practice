...
namespace Week1Practice
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // 2. Declare a number variable called "myAge" and set it equal to your age
            int myAge = 40;
            ...
            {
                Console.WriteLine(productsList[x]);
            }
           ...
           while (g <= 30)
           {
            ...
            int k = 1;
            while (k < myName.Length)
            {
                 k++;
            }
            Console.WriteLine("My name, " + myName + " has " + k + " letters in it");

            // 2. Print out the number of items in your list using the format: "My product list has <number of items> in it."

            int z = 0;
            for (int n = 0; n < productsList.Count; n++)
            {
                z++;   
            }
            Console.WriteLine("My product list has " + z + " items in it."); 


            // 3. Print out the number of letters of each item in productsList using the format: "<product> has <number of letters> in it."
            for (int p = 0; p < productsList.Count; p++)
            {
                
                Console.WriteLine(productsList[p] + " has " + productsList[p].Length + " letters in it");
            }
        ...
        // 3. Using your NewGreeting function as the parameter for Console.WriteLine(), call your NewGreeting function using the parameter myName.
            ...
            int increment = TripleIt(myAge - 10);
            ...
            int startNum = RealMultiply(1, TripleIt(3));
            int endNum = TripleIt(RealMultiply(myAge, 7));
            increment = TripleIt(myAge - RealMultiply(2, 4));
        ...
        public static void SuperLoop(int startNum, int endNum, int increment)
        {
            ...
            int loopCount = 0;
            for (int n = startNum; n <= endNum; n = increment)
            {
                Console.WriteLine(n);
                loopCount++;
            }
            Console.WriteLine("That loop was craaaaaaazy, we looped " + loopCount + "times");
        }
